...
class About extends React.PureComponent {
  ...
  render = () => (
    <Container>
      ...
      <p>
        Follow IPA or Latin links for each letter to learn its pronunciation.
        All Aramaic consonants are common to Standard Arabic as well, except for{' '}
        <a
      ...
      <p>
        For vowel pronunciation follow the links for each individual vowel or
        see{' '}
